// Admin Sidebar Component for NTC
// Left navigation for admin dashboard with responsive design

import React, { useState } from 'react';

export type AdminPage = 'overview' | 'users' | 'partners' | 'promo-codes' | 'documents' | 'translators' | 'payments' | 'analytics' | 'settings' | 'orphans' | 'docreview';
...
const AdminSidebar: React.FC<AdminSidebarProps> = ({ currentPage, onNavigate, onLogout }) => {
  ...
  return (
    <>
      {/* Mobile Header - White with centered logo */}
      ...
      <div className={`
        ...
        w-64 bg-slate-800 min-h-screen flex flex-col border-r border-slate-700
        overflow-hidden
      ...
      `}>
        ...
        <div className="p-6 border-b border-slate-700 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <img src="/log.PNG" alt="NTC" className="h-10 w-10 object-contain" />
            <div>
              <h1 className="text-lg font-bold text-white">NTC Admin</h1>
