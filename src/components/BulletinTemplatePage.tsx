    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-4 sm:gap-0">
            <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
              <button
                ...
                className="flex items-center space-x-2 px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-all duration-200 group text-sm"
            ...
            {/* Status Badge */}
            <div className="flex items-center space-x-2 bg-green-50 border border-green-200 rounded-lg px-3 py-1 sm:px-4 sm:py-2 text-xs sm:text-sm mt-2 sm:mt-0 self-start sm:self-auto">
              <div className="w-2 h-2 bg-green-400 rounded-full"></div>
              <span className="font-medium text-green-700">Print Ready</span>
              <span className="text-green-600">A4 (210×297mm)</span>
            </div>
          </div>
          {/* Control Panel */}
          <div className="bg-gray-50 rounded-xl p-3 sm:p-6 border border-gray-200">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="space-y-3">
                <h3 className="text-xs sm:text-sm font-semibold text-gray-700 uppercase tracking-wide">Template Type</h3>
              ...
              <div className="space-y-3 mt-4 sm:mt-0">
                <h3 className="text-xs sm:text-sm font-semibold text-gray-700 uppercase tracking-wide">Preview Mode</h3>
                <div className="flex flex-col sm:flex-row gap-3">
                  <button
            ...
            {/* Quick Info */}
            <div className="mt-4 flex flex-col sm:flex-row items-start sm:items-center justify-between text-xs sm:text-sm text-gray-600 gap-2 sm:gap-0">
              ...
              <div className="text-xs bg-white rounded-full px-3 py-1 border border-gray-200 mt-2 sm:mt-0">
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 pb-8">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
          ...
          {/* Template Content */}
          <div className="p-3 sm:p-6 overflow-x-auto overflow-y-visible">
            {selectedTemplate === 'form6' ? (
              <Form6Template 
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-200 rounded-2xl p-4 sm:p-6">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h4 className="text-base sm:text-lg font-semibold text-purple-900">Template Differences</h4>
              </div>
              <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-purple-800">
                <li className="flex items-start space-x-2">
