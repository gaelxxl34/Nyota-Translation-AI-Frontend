...
// Document template components for rendering translated documents

export { default as Form4Template } from './Form4Template';
export { default as Form6Template } from './Form6Template';
export { default as StateDiplomaTemplate } from './StateDiplomaTemplate';
export { default as BachelorDiplomaTemplate } from './BachelorDiplomaTemplate';
export { default as CollegeAnnualTranscriptTemplate } from './CollegeAnnualTranscriptTemplate';
