          ...
          <table className="table-fixed w-full border-collapse text-xs">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border border-black px-0.5 py-0.5 text-xs text-center">
                  <EditableField 
                    value={data.summaryValues?.aggregatesMaxima?.period1 || renderGrade(data.totalMarksOutOf?.firstSemester)}
                ...
                <td className="border border-black px-0.5 py-0.5 text-xs text-center">
                  <EditableField 
                    value={data.summaryValues?.aggregatesMaxima?.period2 || renderGrade(data.totalMarksOutOf?.secondSemester)}
              ...
              <tr>
                ...
                <td className="border border-black px-0.5 py-0.5 text-xs text-center">
                  <EditableField 
                    value={data.summaryValues?.aggregates?.period1 || renderGrade(data.totalMarksObtained?.firstSemester)}
                ...
                <td className="border border-black px-0.5 py-0.5 text-xs text-center">
                  <EditableField 
                    value={data.summaryValues?.aggregates?.period2 || renderGrade(data.totalMarksObtained?.secondSemester)}
              ...
              <tr>
                ...
                <td className="border border-black px-0.5 py-0.5 text-xs text-center">
                  <EditableField 
                    value={data.summaryValues?.percentage?.period1 || renderGrade(data.percentage?.firstSemester)}
                ...
                <td className="border border-black px-0.5 py-0.5 text-xs text-center">
                  <EditableField 
                    value={data.summaryValues?.percentage?.period2 || renderGrade(data.percentage?.secondSemester)}
              ...
              <tr>
                ...
                <td className="border border-black px-0.5 py-0.5 text-xs text-center">
                  <EditableField 
                    value={data.summaryValues?.position?.period1 || `${data.position} / ${data.totalStudents}`}
                ...
                <td className="border border-black px-0.5 py-0.5 text-xs text-center">
                  <EditableField 
                    value={data.summaryValues?.position?.period2 || `${data.position} / ${data.totalStudents}`}
